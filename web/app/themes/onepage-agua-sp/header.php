...
<div id="modal-industria-seca" class="modal">
  <div class="content">
    <h1>Em meio à pior crise hídrica da história do Estado de São Paulo, soluções fundamentais foram deixadas de lado na conversa entre Alckmin e Dilma</h1>

    <h2>"Aliança pela Água" critica pacote bilionário de obras que não apresenta plano de emergência, não ataca as causas da falta d’água nem garante níveis seguros dos reservatórios para o próximo período de estiagem.</h2>
    ...
    <p>A Aliança pela Água -- rede de entidades e coletivos da sociedade civil que se organizou em outubro para monitorar as respostas do poder público e propor soluções de curto, médio e longo prazos para superar a crise-- alerta que não existe mais tempo, dinheiro e água para desperdiçar com um conjunto de obras que não vai resolver o problema e ressalta que as propostas apresentadas não atacam suas causas.</p>

    <p>De acordo com a Aliança, adotar esse caminho é insistir no erro: novas e caras obras que não cuidam das nascentes, não recuperam áreas já exploradas e não reduzem consumo e perdas, repetindo o padrão histórico insustentável. Além disso, a prioridade deve ser a apresentação e discussão pública de um plano de contingência que indique como chegar em abril de 2015 em situação segura para garantir o fornecimento durante o próximo período de estiagem.</p>

    <p>Outro ponto que chama a atenção no pacote de medidas discutido por Dilma e Alckmin é a ausência de qualquer menção sobre a recuperação e recomposição dos mananciais existentes - como  a restauração florestal, a ampliação de parques e áreas protegidas, a contenção da expansão urbana sobre áreas de mananciais, além de instrumentos econômicos para promover essas ações. Tampouco se considera os impactos da expansão urbana, do desmatamento e das mudanças climáticas nas mudanças do regime de chuvas.</p>

    <p>O sentido de urgência e a escala do problema são claros: o mês de outubro foi um dos mais secos já registrados e as previsões climáticas para os próximos meses não são animadoras. Os dados indicam que, se chover como em 2013, o colapso é praticamente certo; e, mesmo que chova dentro da média, os mananciais ainda se encontrarão em situação pior do que estavam em abril de 2014.</p>

    <p>Por essas razões, a Aliança da Água cobra a apresentação e discussão imediata de um plano de contingência claro e que priorize a transparência dos dados e da real situação do abastecimento de água no Estado. As organizações da sociedade civil, movimentos, coletivos e pessoas que a compõem defendem que qualquer investimento público em obras de novas transposições e de grande porte deve estar condicionado a plano de sustentabilidade que garanta segurança hídrica e que considere variáveis sociais e climáticas antes de implementar tal infraestrutura, reforçando os instrumentos já estabelecidos pela Lei Nacional de Recursos Hídricos (lei 7.663/1991). No curto e médio prazo, e de forma permanente, é preciso que sejam implantadas ações para diminuir consumo em diferentes escalas, como programas de economia, reuso, captação de água de chuva e redução nas perdas do sistema.</p>

    <p>Impõe-se a necessidade de difusão permanente de informações sobre a crise, para que a população possa enfrentá-la com maior segurança, evitando a proliferação de poços potencialmente contaminados e a reservação inadequada de água. A crise hídrica provavelmente se estenderá por muitos anos e a pouca disponibilidade de água na região metropolitana é uma realidade a ser enfrentada com coragem e gestão cuidadosa. Não basta aumentar a oferta, sem cuidar da demanda.</p>


    <p><strong>Crítica aos investimentos anunciados: </strong></p>

    <ol class="lista">
      <li>O conjunto de intervenções apresentado não resolve a crise atual, é fazer mais do mesmo, ou seja, novas e caras obras que não contemplam medidas estratégicas para criar segurança hídrica.</li>
      <li>Até o momento não foi apresentado um plano de contingência que demonstre como vamos chegar em abril de 2015 em situação segura para encarar o próximo período de estiagem.</li>
      <li>Não foi feita qualquer menção sobre recuperar e cuidar dos mananciais existentes (restauração florestal, ampliação de parques, pagamentos por serviços ambientais)</li>
    </ol>
    ...
    <ol class="lista">
      <li>A apresentação e discussão imediata de um plano de contingência transparente, que permita que a sociedade se organize e se prepare para a crise continuada e o próximo período de estiagem.</li>
      <li>Que sejam implantadas ações imediatas com metas de redução de consumo e de perdas para diferentes tipos de usuários de água, como agricultura, indústria, concessionárias de serviços de saneamento e grandes consumidores urbanos.</li>
      <li>Que todo e qualquer investimento para novas transposições e obras desse porte estejam condicionados a um plano abrangente de segurança hídrica e recuperação das fontes de água existentes, considerando-se variáveis sociais e climáticas, para garantir um futuro seguro e sustentável para a água em São Paulo.</li>
    </ol>
    <p class="center"><strong>Lista das organizações que compõem a Aliança pela Água</strong></p>
    <p class="center">Advogados Ativistas</p>
    <p class="center">Associação Águas Claras do Rio Pinheiros - AACRP</p>
    <p class="center">BEM TE VI Diversidade</p>
    <p class="center">Cidade Democrática</p>
    <p class="center">Coletivo Curupira</p>
    <p class="center">Espaço - Formação, Assessoria e Documentação</p>
    <p class="center">RPPN Fazenda Serrinha</p>
    <p class="center">Grupo Permacultores</p>
    <p class="center">Greenpeace Brasil</p>
    <p class="center">GT Meio Ambiente da Rede Nossa São Paulo</p>
    <p class="center">InfoAmazônia</p>
    <p class="center">Iniciativa Verde</p>
    <p class="center">Instituto 5 Elementos - Educação para a Sustentabilidade;</p>
    ...
    <p class="center">Itu Vai Parar!</p>
    <p class="center">Mapas Coletivos</p>
    <p class="center">Minha Sampa</p>
    <p class="center">Movimento Cisterna Já</p>
    <p class="center">Proteste - Associação de consumidores</p>
    <p class="center">Rede Nossa São Paulo</p>
    <p class="center">Rede de Olho nos Mananciais</p>
    <p class="center">SIBITE</p>
    <p class="center">Sala Crisantempo</p>
    <p class="center">SOS Mata Atlântica</p>
    <p class="center">TNC - The Nature Conservancy</p>
    <p class="center">Virada Sustentável</p>
