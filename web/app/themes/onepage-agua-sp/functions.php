...
// Register Custom Post Type
function novidades_post_type() {

    $labels = array(
        'name'                => _x( 'Novidades', 'Post Type General Name', 'novidades' ),
        'singular_name'       => _x( 'Novidade', 'Post Type Singular Name', 'novidades' ),
        'menu_name'           => __( 'Novidades', 'novidades' ),
        'parent_item_colon'   => __( 'Parent Item:', 'novidades' ),
        'all_items'           => __( 'Todas novidades', 'novidades' ),
        'view_item'           => __( 'Ver novidade', 'novidades' ),
        'add_new_item'        => __( 'Adicionar novidade', 'novidades' ),
        'add_new'             => __( 'Adicionar nova', 'novidades' ),
        'edit_item'           => __( 'Editar novidade', 'novidades' ),
        'update_item'         => __( 'Atualizar novidade', 'novidades' ),
        'search_items'        => __( 'Procurar novidade', 'novidades' ),
        'not_found'           => __( 'Não encontrada', 'novidades' ),
        'not_found_in_trash'  => __( 'Não encontrada na lixeira', 'novidades' ),
    );
    $args = array(
        'label'               => __( 'novidade', 'novidades' ),
        'description'         => __( 'Novidades engloba iniciativas, propostas e ideias para ajudar a enfrentar a crise atual', 'novidades' ),
        'labels'              => $labels,
        'supports'            => array( 'title', 'editor', 'thumbnail', 'comments', 'custom-fields', ),
        'taxonomies'          => array('category'),
        'hierarchical'        => false,
    ...
    register_post_type( 'novidade', $args );

}

// Hook into the 'init' action
add_action( 'init', 'novidades_post_type', 0 );
